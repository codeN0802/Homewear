...
if __name__ == '__main__':
    ...
    #      "price": 24000000,
    #      "image": "images/im0400.jpg",
    #      "category_id": 1
    #     }]
    # for p in products:
    #     pro = Product(name=p['name'], description = p['description'], price = p['price'], image = p['image'],
